// Aguarde o evento 'DOMContentLoaded' que é disparado quando o HTML está completamente carregando
document.addEventListener('DOMContentLoaded', () => {
    //Obtém referência ao botão com ID 'calculadora'
    const botao = document.getElementById('calcularBtn');

    // Adiciona um listenar de evento de clique ao botão
